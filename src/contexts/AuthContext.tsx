...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const fetchProfile = async (userId: string, email?: string, metadata?: Record<string, unknown>) => {
    try {
  ...
  const createProfile = async (userId: string, email?: string, metadata?: Record<string, unknown>) => {
    try {
      const profileData = {
        id: userId,
        email: email || '',
